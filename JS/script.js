function calcular(){
    let mascote, homenagem, leite, kit, suplemento, oleo, feijao2, feijao1, arroz5, arroz1, macarrao, soma, equipe, sangue, animacao, acaoSocial, fotoAs, fotoAcao;
    ...
    soma = mascote + homenagem + animacao + (2 * (leite)) + (5 * (arroz5)) + (1 * (arroz1)) + (2 * (feijao2)) + (1 * (feijao1)) + (0.5 * (macarrao)) + (1 * (oleo)) + (10 * (acaoSocial)) + fotoAs + fotoAcao
